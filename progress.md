...
- [x] Core functionality on primary platform (markdown prompt library, sync to .cursorrules + AGENTS.md)
...
- 2026-05-10 — v0.1 built — TS CLI with markdown prompt library, sync adapters for .cursorrules and AGENTS.md
